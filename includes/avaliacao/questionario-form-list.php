...
foreach ($perguntas as $item) {
   ...
   $result = Resposta::getList('*', 'respostas', 'questao_id=' . $id_pergunta, null, null);
                     ...
                     foreach ($result as $val) {
                        ...
                        switch ($val->tipo_id) {
                           case '1':
                              echo '<tr>
                              <td>
                              <input type="hidden" name="id_questao['.$val->questao_id.']" value="'.$val->questao_id.'" >
                           ...
                           case '2':
                              echo '<tr>
                              <td>
                              <input type="hidden" name="id_questao2['.$val->questao_id.']" value="'.$val->questao_id.'" >
                           ...
                           default:
                           echo '<tr>
                              <input type="hidden" name="id_pergunta" value="'.$val->id.'">
